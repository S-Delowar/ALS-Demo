...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'profession', 'user', 'total_experience_years', 'phone')
    search_fields = ('name', 'profession', 'skills', 'user__email', 'user__username')
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('user', 'name', 'profession', 'summary', 'total_experience_years')
        }),
        ('Contact & Links', {
